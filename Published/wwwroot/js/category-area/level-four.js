...
(function () {
    const controller = 'CategoryLevelFour';
    ...
    const columns = () => [
        { field: 'LevelOneParentName', Width: '200px', title: 'Level One Parent', filter: true, add: false },
        { field: 'LevelTwoParentName', Width: '200px', title: 'Level Two Parent', filter: true, add: false },
        { field: 'LevelThreeParentName', Width: '200px', title: 'Level Three Parent', filter: true, add: false },
    ...
    const add = () => {
        const filterForParentTwoAutoComplete = { "field": "LevelOneParent", "value": '00000000-0000-0000-0000-000000000000', "Operation": 0 };
        const filterForParentThreeAutoComplete = { "field": "LevelTwoParent", "value": '00000000-0000-0000-0000-000000000000', "Operation": 0 };
        let parentTwoAutoComplete;
        let parentThreeAutoComplete;
        ...
        Global.Add({
            ...
            },
            {
                ...
                onchange: function (data) {
                    if (data) {
                        filterForParentTwoAutoComplete.value = data.Id;
                    } else {
                        filterForParentTwoAutoComplete.value = '00000000-0000-0000-0000-000000000000';
                    }
                    parentTwoAutoComplete.Reload();
                },
                page: { 'PageNumber': 1, 'PageSize': 20, filter: [{ "field": "IsDeleted", "value": 0, "Operation": 0 }] },
            }, parentTwoAutoComplete = {
                title: 'Level Two Parent',
                Id: 'LevelTwoParent',
                url: `/CategoryLevelTwo/AutoComplete`,
                type: 'AutoComplete',
                position: 8,
                page: { 'PageNumber': 1, 'PageSize': 20, filter: [filterForParentTwoAutoComplete, { "field": "IsDeleted", "value": 0, "Operation": 0 }] },
                onchange: function (data) {
                    if (data) {
                        filterForParentThreeAutoComplete.value = data.Id;
                    } else {
                        filterForParentThreeAutoComplete.value = '00000000-0000-0000-0000-000000000000';
                    }
                    parentThreeAutoComplete.Reload();
                },
            }, parentThreeAutoComplete = {
                title: 'Level Three Parent',
                Id: 'LevelThreeParent',
                url: `/CategoryLevelThree/AutoComplete`,
                type: 'AutoComplete',
                position: 8,
                page: { 'PageNumber': 1, 'PageSize': 20, filter: [filterForParentThreeAutoComplete, { "field": "IsDeleted", "value": 0, "Operation": 0 }] },
            }],
            additionalField: [],
