    ...
    this.Show = function (options) {
        ...
        function addCourseStudentAttendance(page) {
            ...
            Global.Add({
                ...
                filter: [],
                save: `/CourseAttendanceDate/Create`,
            });
        }
        ...
        const batchStudentList = (row, model) => {
            ...
            Global.Add({
                ...
                url: '/js/course-batchattendance-area/course-studentlist-details-modal.js',
        ...
        Global.Add({
            title: 'Course AttendanceDate Information',
            selected: 0,
            Tabs: [
                {
                    ...
                    Grid: [{
                        ...
                        buttons: [
                            {
                                click: addCourseStudentAttendance,
            ...
            name: 'Course AttendanceDate Information',
