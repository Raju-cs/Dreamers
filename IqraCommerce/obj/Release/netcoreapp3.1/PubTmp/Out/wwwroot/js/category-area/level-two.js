...
(function () {
    const controller = 'CategoryLevelTwo';
    ...
    const add = () => {
        Global.Add({
            name: 'CREATE_LEVEL_TWO_CATEGORY',
            model: undefined,
            title: 'CREATE LEVEL TWO CATEGORY',
            columns: columns(),
            dropdownList: [{
    ...
    const edit = (model) => {
        Global.Add({
            name: 'EDIT_LEVEL_TWO_CATEGORY',
            model: model,
            title: 'EDIT LEVEL TWO CATEGORY',
            columns: columns(),
            dropdownList: [{
                title: 'Show in client',
                Id: 'IsVisible',
