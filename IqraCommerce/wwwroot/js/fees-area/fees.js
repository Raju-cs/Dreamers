...
(function () {
    ...
    const columns = () => [
        { field: 'StudentName', title: 'Student Name', filter: true, add: false, position: 1, },
        { field: 'Period', title: 'Month', filter: true, position: 2, add: { sibling: 2, }, add: false, dateFormat: 'yyyy/dd/MM', required: false, },
        { field: 'Fee', title: 'Fee', filter: true, add: { sibling: 2, }, position: 3,  },
        { field: 'TotalFee', title: 'TotalFee', filter: true, add: { sibling: 2, }, position: 4,  },
        ...
        { field: 'RestFee', title: 'RestFee', filter: true, add: { sibling: 2, }, position: 7,  },
