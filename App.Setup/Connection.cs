...
namespace App.Setup
{
    public class Connection
    {
        ...
        //public static string DBName { get { return "DB_ShoppersPark"; } }
        //public static string ConnectionString = @"data source=103.108.140.160,1434;initial catalog=" + DBName + ";persist security info=True;user id=ShoppersPark;password=Shoppers@123;MultipleActiveResultSets=True";
